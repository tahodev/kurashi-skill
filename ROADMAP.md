...
| 28 | `garbage-day` | ごみ収集日の照会 | 自治体オープンデータ(5374など) | 不要 | 市町村ごとに形式がまちまちでカバレッジに限界あり。その限界自体を記事の題材にする |
...
| `estat-stats` | 政府統計の統計表検索(e-Stat API、無料appId) | 暮らしというよりデータ基盤寄り。calil-books方式のキー前提スキルとして扱える |
